...
export const enDictionary: Dictionary = {
  ...
  adminHomeMap: {
    ...
    navHomeMap: "Map manager",
    navSecurity: "Security",
    navTranslations: "Title translations",
    navAppTexts: "System texts",
    signedInAs: "Admin is signed in",
    signOut: "Sign out",
    save: "Save",
    visible: "Show on home map",
    attractMode: "Use in attract mode",
    priority: "Priority",
    ...
    inactiveCount: "Inactive municipalities",
  ...
  adminAppTexts: {
    ...
    intro: "Edit the app text directly in the database. Use this as the runtime source instead of depending on versioned files for small copy fixes.",
